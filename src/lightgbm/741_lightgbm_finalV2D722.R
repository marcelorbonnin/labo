...
kprefijo       <- "KA741D722V2"
ksemilla_azar  <- 727019  #Aqui poner la propia semilla
...
kmax_bin           <-    31
klearning_rate     <-     0.0217921381164438
knum_iterations    <-   801
knum_leaves        <-  385
kmin_data_in_leaf  <- 13018
kfeature_fraction  <-     0.201686097992895
