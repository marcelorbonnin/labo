...
kprefijo       <- "KA741D722V1"
ksemilla_azar  <- 405401  #Aqui poner la propia semilla
kdataset       <- "./datasets/paquete_premium_ext_722.csv.gz"

#donde entrenar
kfinal_mes_desde    <- 202002        #mes desde donde entreno
...
kmax_bin           <-    31
klearning_rate     <-     0.0101381541161932
knum_iterations    <-   724
knum_leaves        <-  1741
kmin_data_in_leaf  <- 12421
kfeature_fraction  <-     0.427884636376201
